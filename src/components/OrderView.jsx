...
const OrdersView = () => {
  ...
  return (<div className="space-y-6">
    ...
    <div className="flex items-end justify-between px-1">
      ...
      <p
        className="hidden sm:block text-slate-500 text-[10px] font-bold uppercase tracking-widest bg-slate-800/50 px-2 py-1 rounded border border-slate-700/30">
        Updated 1 min ago
      </p>
    </div>
    ...
    <div
      ...
      <div
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2">
            ...
            <span
              className="bg-blue-500/10 text-blue-400 text-[10px] px-2 py-0.5 rounded-full border border-blue-500/20 font-bold">
                {totalItems}
              </span>
          </div>
      ...
      {loading ? <div className="flex justify-center py-4">
        <ShoeCircularLoader/>
      </div> : (<div className="overflow-x-auto min-h-[420px]">
        {totalItems > 0 ? (<OrdersTable orders={paginatedOrders}/>) : (
