...
const UserView = () => {
  ...
  return (<div className="space-y-5 animate-in fade-in duration-500">
      ...
      {loading ? <ShoeCircularLoader/> : <div
              ...
              return (
                ...
                >
                  <td className="px-6 py-4">
                    <div
                      className="w-9 h-9 rounded-xl bg-gradient-to-br from-slate-800 to-slate-950 border border-slate-700/50 flex items-center justify-center text-blue-400 font-bold text-[11px] shadow-lg">
                      {u.fullname.charAt(0)}
                    </div>
                  </td>
                  <td className="px-6 py-4">
